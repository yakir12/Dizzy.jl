...
#define NLEDS 198
#define DATA_PIN 16   // MOSI on ICSP pin 4
#define CLOCK_PIN 15  // SCK  on ICSP pin 3
#define BAUDRATE 115200

CRGB leds[NLEDS];

uint8_t ARDUINO_ID[8] = { 151, 152, 146, 82, 39, 59, 146, 254 };
...
void onPacketReceived(const uint8_t* buff, size_t nb) {
  if (nb % 2 == 0) {
    ...
    FastLED.show();
      ...
      myPacketSerial.send(ARDUINO_ID, 8);
  }
}
